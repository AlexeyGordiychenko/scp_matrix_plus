...
TEST(SubMatrix, 1) {
  S21Matrix m1({4, 4, 0.7377235853333906, 926855766.1159714, 63238473.00124812,
                ...
                0.8092604699880203});
  S21Matrix m2({4, 4, -6434480088.156957, 51309.60774172201, 782190037.1280999,
                ...
                4139286.5688904035});
  S21Matrix m1_res({4, 4, 6434480088.89468, 926804456.5082297,
...
TEST(SubMatrix, 3) {
  S21Matrix m1({1, 1, 9027.26148921451});
  S21Matrix m2({1, 1, -22600.35955967138});
  S21Matrix m1_res({1, 1, 31627.62104888589});
...
TEST(SubMatrix, 4) {
  S21Matrix m1({5, 2, 16383.156881853289, 964968.0880741832,
  ...
  S21Matrix m2({5, 2, -0.5502057727352931, -5375.164699610609,
  ...
  S21Matrix m1_res({5, 2, 16383.707087626024, 970343.2527737938,
...
TEST(SubMatrix, 6) {
  S21Matrix m1({2, 2, -7.4841694488077435, 300799.244639009,
                -0.27616617665772825, 0.6720692906781218});
  S21Matrix m2({2, 2, -6712038288.32716, 408.2556139926829, 0.9115965151758949,
                -5759750325.136459});
  S21Matrix m1_res({2, 2, 6712038280.842991, 300390.9890250163,
...
TEST(SubMatrix, 7) {
  S21Matrix m1({7,
                ...
                -312124.0969284056,
                -8762878.80902852});
  S21Matrix m2({1, 1, 1581439612.227271});
