...
TEST(Determinant, 1) {
  S21Matrix m1({2, 2, -7031.7137539574305, -603774689.5740736,
...
TEST(Determinant, 2) {
  S21Matrix m1({1, 1, -672.8542607492762});
...
TEST(Determinant, 6) {
  S21Matrix m1({2, 2, 395112.66923456464, -51176140.06943026, -560924955.809116,
                -0.8554685361262996});
...
TEST(Determinant, 7) {
  S21Matrix m1({2, 2, -12.462421228686793, -4.951680475927182,
...
TEST(Determinant, 8) {
  S21Matrix m1({1, 1, -99085197.06478257});

  EXPECT_EQ(m1.Determinant(), -99085197.06478257);
}

TEST(Determinant, 9) {
  S21Matrix m1({1, 1, 51847.25361707124});

  EXPECT_EQ(m1.Determinant(), 51847.25361707124);
}

TEST(Determinant, 10) {
  S21Matrix m1({2, 2, 750332.9841843336, 7.882913320419734, -63417085.30901616,
                590168.9345559892});
