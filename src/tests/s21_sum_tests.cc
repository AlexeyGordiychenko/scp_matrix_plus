...
TEST(SumMatrix, 0) {
  S21Matrix m1({1, 1, 3357.09085222302});
  S21Matrix m2({1, 1, -9.623990419208303});
  S21Matrix m1_res({1, 1, 3347.4668618038118});
...
TEST(SumMatrix, 1) {
  S21Matrix m1({2, 2, -969.9898620170793, 2865147076.100971, 1891.2700137689776,
                0.9306220789776865});
  S21Matrix m2({5,
                6,
                31799261.584055103,
...
TEST(SumMatrix, 7) {
  S21Matrix m1({3, 4, -609848.6447431121, 6632748.786139828, -701626118.5440103,
  ...
  S21Matrix m2({3, 4, 5435659896.306934, 0.6001174523961113, 989309.4888820841,
  ...
  S21Matrix m1_res({3, 4, 5435050047.662191, 6632749.386257281,
...
TEST(SumMatrix, 8) {
  S21Matrix m1({2, 7, 6341.690071248289, -63285196.16255154,
  ...
  S21Matrix m2({2, 7, -1.826115201732268, 368471282.7393339,
  ...
  S21Matrix m1_res({2, 7, 6339.863956046557, 305186086.5767824,
